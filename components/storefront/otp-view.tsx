...
import { clearOtpChallenge, createOtpChallenge, createSessionToken, maskPhone, readOtpChallenge, type OtpChallenge } from "@/lib/auth";
...
export function OtpView({ labels }: { labels: Record<string, string> }) {
  ...
  const verify = () => {
    ...
    createSessionToken(challenge.phone);
    clearOtpChallenge();
